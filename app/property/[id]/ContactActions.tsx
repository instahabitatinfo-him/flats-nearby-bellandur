      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-[0_-4px_14px_rgba(0,0,0,0.10)]">
        <div className="max-w-md mx-auto px-5 py-3">
          ...
          <button
            ...
            className="w-full mt-3 bg-orange-500 text-white text-center py-3.5 rounded-xl font-semibold active:scale-[0.98] transition"
          >
            📅 Request Visit
          </button>
        </div>
...
<button
    ...
    onClick={async () => {
      ...
      try {
        const result = await handleVisitRequest();
        ...
        if (ownerResponseUrl && brokerWhatsapp) {
          const brokerWhatsAppNumber =
            brokerWhatsapp.replace(/\D/g, "");
